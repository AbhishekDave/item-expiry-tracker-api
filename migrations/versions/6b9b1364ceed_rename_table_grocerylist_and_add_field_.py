"""rename table groceryList and add field in groceryItem

Revision ID: 6b9b1364ceed
Revises: a944615871d4
Create Date: 2024-10-22 17:26:47.865596
...
revision = '6b9b1364ceed'
down_revision = 'a944615871d4'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    with op.batch_alter_table('grocery_item', schema=None) as batch_op:
        batch_op.add_column(sa.Column('grocery_list_name_id', sa.Integer(), nullable=True))
        batch_op.add_column(sa.Column('is_active', sa.Boolean(), nullable=True))
        batch_op.drop_index('ix_grocery_item_grocery_name_id')
        batch_op.drop_index('ix_grocery_item')
        batch_op.create_index('ix_grocery_item', ['grocery_list_name_id', 'item_id'], unique=False)
...
def downgrade():
    ...
    with op.batch_alter_table('grocery_item', schema=None) as batch_op:
        ...
        batch_op.create_index('ix_grocery_item_grocery_name_id', ['grocery_name_id'], unique=False)
        batch_op.drop_column('is_active')
        batch_op.drop_column('grocery_list_name_id')
